...
MATNAME_WORD_RU = {
    ...
    # декоративні кольори/фінішні назви — конкретні слова, які раніше не
    # перекладалися (побачено в назвах декоративних покриттів на сайті:
    # "нічне сяйво", "нюд", "платиновий" і т.п.) — це НЕ огризки/скорочення
    # (на відміну від "ЕЛ.ВОД."/"6ММ", які лишаємо як є — їх нема як
    # однозначно розшифрувати), а звичайні цілі слова, тому мають
    # перекладатися так само, як інші кольори вище.
    "нічне": "ночное", "нічний": "ночной", "нічна": "ночная", "сяйво": "сияние",
    "нюд": "нюд", "платиновий": "платиновый", "платинова": "платиновая",
    "платинове": "платиновое", "сієнна": "сиенна",
    # часто зустрічаються скорочені до кореня слова (постачальник сам ріже
    # назву під ліміт довжини) — на щастя, корінь пишеться однаково або
    # майже однаково і в укр., і в рос., тож лишаємо як є замість того, щоб
    # видати обрубок недоперекладеного слова.
    "природ": "природ", "стал": "стал", "корич": "корич",
    "перламутровий": "перламутровый", "перламутрова": "перламутровая",
    "золотистий": "золотистый", "золотиста": "золотистая",
    "бронзовий": "бронзовый", "бронзова": "бронзовая",
    "мідний": "медный", "мідна": "медная", "срібло": "серебро", "золото": "золото",
    "ваніль": "ваниль", "капучино": "капучино", "шампань": "шампань",
    "кремовий": "кремовый", "кремова": "кремовая",
    "пастельний": "пастельный", "пастельна": "пастельная",
    "теракотовий": "терракотовый", "теракотова": "терракотовая",
    "бузковий": "сиреневый", "бузкова": "сиреневая",
    "малиновий": "малиновый", "малинова": "малиновая",
    "бордовий": "бордовый", "бордова": "бордовая",
    "лавандовий": "лавандовый", "лавандова": "лавандовая",
    "перловий": "жемчужный", "перлова": "жемчужная",
    "лимонний": "лимонный", "лимонна": "лимонная",
    "вишневий": "вишнёвый", "вишнева": "вишнёвая",
    "гранатовий": "гранатовый", "гранатова": "гранатовая",
    "сталевий": "стальной", "сталева": "стальная",
    "антрацитовий": "антрацитовый", "антрацитова": "антрацитовая",
}
